...
CREATE TABLE CUSTOMER_PROFILE (
    ...
    credit_limit DECIMAL(15,2),  -- Untuk B2B
    loyalty_points INT DEFAULT 0,  -- Untuk B2C
    member_tier VARCHAR(20) DEFAULT 'Bronze'  -- Untuk B2C
);
...
-- 1. Insert OWNER
INSERT INTO OWNER (nama_owner, no_hp) VALUES
('Admin Utama', '081234567890'),
...
-- 4. Insert CUSTOMER (B2B)
INSERT INTO CUSTOMER (nama_customer, tipe, no_hp, email) VALUES
('Toko Kue Manis', 'B2B', '081234567893', 'tokomanis@email.com'),
('Bakery Sejahtera', 'B2B', '081234567894', 'bakery@email.com');

-- 5. Insert CUSTOMER_PROFILE (B2C)
INSERT INTO CUSTOMER_PROFILE (customer_id, alamat, loyalty_points, member_tier) VALUES
(1, 'Jl. Mawar No. 10, Malang', 150, 'Silver'),
(2, 'Jl. Melati No. 20, Malang', 50, 'Bronze'),
(3, 'Jl. Kenanga No. 15, Malang', 300, 'Gold');

-- 6. Insert CUSTOMER_PROFILE (B2B)
INSERT INTO CUSTOMER_PROFILE (customer_id, alamat, npwp, pic_name, payment_terms, credit_limit) VALUES
(4, 'Jl. Raya Bisnis No. 100, Malang', '12.345.678.9-012.345', 'Ahmad Reseller', 'NET 30', 10000000),
(5, 'Jl. Industri No. 50, Malang', '98.765.432.1-098.765', 'Rina Bakery', 'NET 14', 5000000);

-- 7. Insert EVENT_KATEGORI
...
-- 8. Insert EVENT
INSERT INTO EVENT (kategori_id, nama_event, tgl_mulai, tgl_selesai, lokasi_spesifik, status) VALUES
(1, 'FIB Brawijaya 2025', '2025-03-15', '2025-03-17', 'Booth A5, Gedung FIB', 'Planned'),
(1, 'Bazaar Imlek 2026', '2026-01-28', '2026-01-30', 'Malang Town Square', 'Planned'),
(1, 'Car Free Day', '2025-12-15', '2025-12-15', 'Jl. Ijen Malang', 'Planned'),
(1, 'Festival Kuliner', '2026-02-10', '2026-02-12', 'Alun-alun Malang', 'Planned');

-- 9. Insert PENJUALAN (Event)
INSERT INTO PENJUALAN (tgl_penjualan, customer_id, owner_id, event_id, tipe_penjualan, total_transaksi, keterangan) VALUES
('2025-03-15', 1, 1, 1, 'B2C', 125000, 'Beli di event FIB'),
('2025-03-16', 2, 1, 1, 'B2C', 150000, 'Beli di event FIB'),
('2025-03-17', 4, 1, 1, 'B2B', 500000, 'Order grosir di event');

-- 10. Insert PENJUALAN (Non-Event)
INSERT INTO PENJUALAN (tgl_penjualan, customer_id, owner_id, event_id, tipe_penjualan, total_transaksi, keterangan) VALUES
('2025-11-01', 1, 1, NULL, 'B2C', 50000, 'Beli online'),
('2025-11-02', 3, 2, NULL, 'B2C', 75000, 'Beli langsung ke toko'),
('2025-11-05', 5, 1, NULL, 'B2B', 1000000, 'Order grosir besar');

-- 11. Insert PENJUALAN_DETAIL
INSERT INTO PENJUALAN_DETAIL (penjualan_id, produk_id, qty, harga_satuan, subtotal) VALUES
-- Detail untuk penjualan_id 1
(1, 1, 2, 50000, 100000),
(1, 3, 1, 75000, 75000),
-- Detail untuk penjualan_id 2
(2, 2, 2, 75000, 150000),
-- Detail untuk penjualan_id 3
(3, 1, 10, 50000, 500000),
-- Detail untuk penjualan_id 4
(4, 1, 1, 50000, 50000),
-- Detail untuk penjualan_id 5
(5, 3, 1, 75000, 75000),
-- Detail untuk penjualan_id 6
(6, 1, 10, 50000, 500000),
(6, 2, 5, 75000, 375000);

-- 12. Insert SUPPLIER
INSERT INTO SUPPLIER (nama_supplier, kontak_person, no_telepon, alamat) VALUES
('CV Tepung Sejahtera', 'Budi Santoso', '081234567895', 'Jl. Industri No. 123, Malang'),
('Toko Kemasan Makmur', 'Siti Aminah', '081234567896', 'Jl. Pasar Besar No. 45, Malang');

-- 13. Insert PURCHASE_ORDER
INSERT INTO PURCHASE_ORDER (supplier_id, created_by, po_no, tgl_po, status, grand_total, keterangan) VALUES
(1, 1, 'PO-2025-001', '2025-11-01', 'Received', 5000000, 'Beli bahan baku bulan November'),
(2, 1, 'PO-2025-002', '2025-11-01', 'Received', 2000000, 'Beli kemasan');

-- 14. Insert PO_ITEM
INSERT INTO PO_ITEM (po_id, item_category, nama_item, qty_ordered, harga_satuan, subtotal) VALUES
(1, 'Bahan Baku', 'Tepung Terigu 50kg', 10, 300000, 3000000),
(1, 'Bahan Baku', 'Coklat Chip 10kg', 5, 400000, 2000000),
(2, 'Kemasan', 'Box Cookie isi 100', 20, 100000, 2000000);

-- 15. Insert AKUN_KEUANGAN
...
-- 16. Insert BEBAN_OPERASIONAL (Event)
INSERT INTO BEBAN_OPERASIONAL (tanggal, jenis_beban, keterangan, nominal, owner_id, event_id) VALUES
('2025-03-15', 'Sewa Booth', 'Sewa booth event FIB 3 hari', 800000, 1, 1),
('2025-03-15', 'Transport', 'Angkut barang ke event FIB', 200000, 1, 1);

-- 17. Insert BEBAN_OPERASIONAL (Non-Event)
INSERT INTO BEBAN_OPERASIONAL (tanggal, jenis_beban, keterangan, nominal, owner_id, event_id) VALUES
('2025-11-01', 'Bahan Baku', 'Beli tepung, telur, coklat', 2000000, 1, NULL),
('2025-11-01', 'Kemasan', 'Beli kardus & stiker', 500000, 1, NULL),
('2025-11-05', 'Transport', 'Ongkir kirim pesanan', 150000, 1, NULL),
('2025-11-10', 'Sewa', 'Sewa tempat produksi', 1200000, 1, NULL);
...
GROUP BY e.event_id, e.nama_event, e.lokasi_spesifik
ORDER BY laba DESC;
...
GROUP BY jenis_beban
ORDER BY total DESC;

-- 6. Ringkasan Dashboard
SELECT 
    (SELECT SUM(total_transaksi) FROM PENJUALAN) AS total_penjualan,
    (SELECT COUNT(*) FROM CUSTOMER) AS total_customer,
    (SELECT SUM(qty) FROM PENJUALAN_DETAIL) AS total_produk_terjual,
    (SELECT SUM(nominal) FROM BEBAN_OPERASIONAL) AS total_beban,
    (SELECT SUM(total_transaksi) FROM PENJUALAN) - 
    (SELECT SUM(nominal) FROM BEBAN_OPERASIONAL) AS laba_bersih;
